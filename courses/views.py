...
def create_course(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            course_published.send(sender=models.Course, course=form.instance, user=request.user)
...
def create_course_topic(request, course_id, part_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'course_topic_form.html', {'form': form, 'course_id': course_id, 'part_id': part_id})
    else:
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            if not form.cleaned_data.get('file'):
                ...
                return render(request, 'topic_document_form.html', {'form': form, 'course_id': course_id, 'part_id': part_id, 'topic_id': topic_id})
...
def update_course_part(request, course_id, part_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'course_part_form.html', {'form': form, 'course_id': course_id, 'part_id': part_id, 'is_edit': True})
    else:
...
def update_course_topic(request, course_id, part_id, topic_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'course_topic_form.html', {'form': form, 'course_id': course_id, 'part_id': part_id, 'topic_id': topic_id, 'is_edit': True})
    else:
        form = forms.CourseTopicForm(initial={'title': topic.title, 'description': topic.description})
        return render(request, 'course_topic_form.html', {'form': form, 'course_id': course_id, 'part_id': part_id, 'topic_id': topic_id, 'is_edit': True})
...
def update_topic_document(request, course_id, part_id, topic_id, document_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'topic_document_form.html', {'form': form, 'course_id': course_id, 'part_id': part_id, 'topic_id': topic_id, 'document_id': document_id, 'document': document, 'is_edit': True})
    else:
