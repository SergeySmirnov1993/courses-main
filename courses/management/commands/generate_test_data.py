...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            default='faker',
            help='Метод генерации данных: faker (напрямую через Faker) или seeder (через django-seed) (по умолчанию: faker)'
        )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'Начинаем генерацию {count} тестовых данных методом {method}...'))
        ...
        self.stdout.write(self.style.SUCCESS(f'Успешно создано {count} тестовых курсов!'))
    ...
    def create_test_documents_dir(self):
        ...
        for filename in test_files:
            ...
            if not file_path.exists():
                ...
                file_path.write_text(f'Тестовый документ: {filename}\nЭто тестовый файл для генерации данных.')

        self.stdout.write(self.style.SUCCESS(f'Создана директория для тестовых документов: {test_docs_dir}'))
    ...
    def create_document_with_faker(self, topic, fake, index):
        ...
        if test_files:
            ...
            dest_dir = Path(settings.MEDIA_ROOT) / 'courses' / course_slug / part_slug / topic_slug
            ...
            document = models.TopicDocument.objects.create(
                topic=topic,
            ...
            self.stdout.write(self.style.WARNING(f'Нет тестовых файлов в {test_docs_dir}'))
